...
private:
    ...
    /**
     * option for disabling v1 connections on IPV4 and IPV6.
     * connections on IPV4/IPV6 need to be v2 connections.
     * connections on Tor/I2P/CJDNS maybe v1 or v2 connections.
     */
