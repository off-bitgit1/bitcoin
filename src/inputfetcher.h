 ...
 * into the CoinsTip.
 *
 * One thread (the main) is assumed to push batches of outpoints
 ...
 * the main is done adding outpoints, it starts writing the results of the reads
 * from the queue to the cache.
 */
class InputFetcher
{
private:
...
public:
    ...
    //! Fetch all inputs and write to cache the cache.
